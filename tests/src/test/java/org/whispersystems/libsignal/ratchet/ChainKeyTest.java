...
public class ChainKeyTest extends TestCase {
  ...
  public void testChainKeyDerivationV2() throws NoSuchAlgorithmException {
    ...
    public void testChainKeyDerivationOmemo2() throws NoSuchAlgorithmException {
        ...
        byte[] messageKey = {
                /* (byte) 0x02*/
                (byte) 0x0f, (byte) 0x6c, (byte) 0x97, (byte) 0x68, (byte) 0x63, (byte) 0x33, (byte) 0x6e, (byte) 0x89,
                (byte) 0xbf, (byte) 0x7c, (byte) 0x8c, (byte) 0x10, (byte) 0xc1, (byte) 0x8d, (byte) 0x9f, (byte) 0xde,
                (byte) 0x60, (byte) 0xb4, (byte) 0xde, (byte) 0xbd, (byte) 0x1f, (byte) 0xf8, (byte) 0x32, (byte) 0xb8,
                (byte) 0x63, (byte) 0xbb, (byte) 0xb1, (byte) 0x9e, (byte) 0xeb, (byte) 0x4c, (byte) 0x88, (byte) 0x24};

        byte[] macKey = {
                (byte) 0x36, (byte) 0x0a, (byte) 0x0e, (byte) 0x0a, (byte) 0x03, (byte) 0x2c, (byte) 0xaa, (byte) 0x4f,
                (byte) 0xf6, (byte) 0x80, (byte) 0x92, (byte) 0xa5, (byte) 0x6e, (byte) 0x90, (byte) 0xbb, (byte) 0xe5,
                (byte) 0x3e, (byte) 0x81, (byte) 0xe2, (byte) 0x24, (byte) 0xe9, (byte) 0x3f, (byte) 0xfb, (byte) 0x2d,
                (byte) 0x0b, (byte) 0xb7, (byte) 0xc0, (byte) 0xf4, (byte) 0xc2, (byte) 0xa0, (byte) 0x18, (byte) 0x38};

        byte[] nextChainKey = {
                (byte) 0x28, (byte) 0xe8, (byte) 0xf8, (byte) 0xfe, (byte) 0xe5, (byte) 0x4b, (byte) 0x80, (byte) 0x1e,
                (byte) 0xef, (byte) 0x7c, (byte) 0x5c, (byte) 0xfb, (byte) 0x2f, (byte) 0x17, (byte) 0xf3, (byte) 0x2c,
                (byte) 0x7b, (byte) 0x33, (byte) 0x44, (byte) 0x85, (byte) 0xbb, (byte) 0xb7, (byte) 0x0f, (byte) 0xac,
                (byte) 0x6e, (byte) 0xc1, (byte) 0x03, (byte) 0x42, (byte) 0xa2, (byte) 0x46, (byte) 0xd1, (byte) 0x5d};

        ChainKey chainKey = new ChainKey(HKDF.createFor(4), seed, 0);

        assertTrue(Arrays.equals(chainKey.getKey(), seed));
        assertTrue(Arrays.equals(chainKey.getMessageKeys(true).getCipherKey().getEncoded(), messageKey));
        assertTrue(Arrays.equals(chainKey.getMessageKeys(true).getMacKey().getEncoded(), macKey));
        assertTrue(Arrays.equals(chainKey.getNextChainKey().getKey(), nextChainKey));
        assertTrue(chainKey.getIndex() == 0);
        assertTrue(chainKey.getMessageKeys().getCounter() == 0);
        assertTrue(chainKey.getNextChainKey().getIndex() == 1);
        assertTrue(chainKey.getNextChainKey().getMessageKeys(true).getCounter() == 1);
    }
}
